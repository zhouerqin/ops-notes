...
graph TD
    ...
    subgraph PV层
        PV1["PV1<br/>pvcreate /dev/sdb1"]
        PV2["PV2<br/>pvcreate /dev/sdc1"]
        PV3["PV3<br/>pvcreate /dev/sdd1"]
    end
    
    subgraph VG层
        VG1["VG1: centos<br/>vgcreate centos /dev/sdb1"]
    end
    
    subgraph LV层
        LV1["LV1: /dev/centos/root<br/>lvcreate -L 20G -n root centos"]
        LV2["LV2: /dev/centos/home<br/>lvcreate -L 50G -n home centos"]
    end
